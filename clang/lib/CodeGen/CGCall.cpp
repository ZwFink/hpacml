...
RValue CodeGenFunction::EmitCall(const CGFunctionInfo &CallInfo,
    ...
    if ( TargetDecl->getApprox() ){
        std::cout<<"I am appending Target Meta Data" << std::endl;
        llvm::LLVMContext& C = CI->getContext();
        llvm::MDNode *N = llvm::MDNode::get(C,llvm::MDString::get(C,"my approximate metadata"));
        CI->setMetadata(llvm::LLVMContext::MD_approx_call, N);
    }
