...
RValue CodeGenFunction::EmitCallExpr(const CallExpr *E,
    ...
    if ( E->getApprox() ){
        std::cout<< "Propagating To Code Generation" << std::endl;
        //We need to revisit this point I should 
        //not need to assign const like that
        Decl *TargetDecl = const_cast<Decl *> (callee.getAbstractInfo().getCalleeDecl().getDecl());
        TargetDecl->setApprox(true);
    }
