...
StmtResult Parser::HandlePragmaApproximate(StmtVector &Stmts){
    std::cout<<"I am performing the systaxical analysis of the approximate statement"<<std::endl;
...
Retry:
    ...
    switch (Kind) {
        ...
        case tok::annot_pragma_approx:
                          ProhibitAttributes(Attrs);
                          return HandlePragmaApproximate(Stmts);
