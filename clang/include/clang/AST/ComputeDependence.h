...
class ApproxArrayShapingExpr;
class ApproxIteratorExpr;
...
ExprDependence computeDependence(ApproxArrayShapingExpr *E);
ExprDependence computeDependence(ApproxIteratorExpr *E);
