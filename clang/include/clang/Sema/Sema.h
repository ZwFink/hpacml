...
namespace clang {
    ...
    class Sema final {
        ...
        //APPROX Semantic Analysis
        //A.T.M this is mainly a place holder
        //to implement the later on any actions on 
        //clause. In essence if we do outlining
        //this needs to be performed here.
   private:
        void ActOnApprox();
        bool isApprox;
